...
model = PUModel(in_channels=16, hidden_channels=hc, num_features=7, out_channels=1, GNN=GATv2Conv)
...
eval_model = PUModel(in_channels=16, hidden_channels=hc, num_features=7, out_channels=1, GNN=GATv2Conv)
